                ...
                if isinstance(datasheets, list):
                    for datasheet in datasheets:
                        ...
                        lists_not_empty = all(
                            ...
                            for value in [
                                part.get("specs", []),
                                part.get("descriptions", []),
                                part.get("documentCollections", []),
                            ]
                        )
                        ...
                        if lists_not_empty:
                            ...
                            print(f"Skipping {filename}: JSON data is missing data")
                            excluded += 1
...
output_file_path = os.path.join(script_dir, "..", "datasets", output_file_name)
